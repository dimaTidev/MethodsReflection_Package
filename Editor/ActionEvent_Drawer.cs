...
//public class ActionEvent_Drawer : MonoBehaviour

// IngredientDrawer
[CustomPropertyDrawer(typeof(ActionEvent<>))]
public class ActionEvent_Drawer : PropertyDrawer
{
    // Draw the property inside the given rect
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        EditorGUI.LabelField(position, "show up");
        ...
        expandRect.height = EditorGUIUtility.singleLineHeight;
    ...
    void DrawComponent(Rect rect, SerializedProperty property)
    {
